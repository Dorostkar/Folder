...
import Drawer from '@material-ui/core/Drawer';class Dashboard extends Component{
    constructor(props){
        super(props);
    }
            ...
            >
              <Toolbar disableGutters={!this.state.open} className={classes.toolbar}>
                ...
                onClick={this.handleOpenProfileMenu}>
                    ...
                    src="http://lorempixel.com/400/200/cats/1" 
                   /> 
                </IconButton>
                    <Menu
                    id="simple-menu"
                    ...
                    >
                        ...
                        <MenuItem onClick={this.handleCloseProfileMenu}>Logout</MenuItem>
                    </Menu>
              </Toolbar>
            </AppBar>
            <Drawer
